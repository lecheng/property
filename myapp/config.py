...
class BaseConfig(object):
    ...
    # mail accounts
    MAIL_DEFAULT_SENDER = 'lechengbupt@gmail.com'
...
class ProductionConfig(BaseConfig):
    ...
    # production config file at production.cfg
    config_path = os.path.join(basedir,'production.cfg')
    ...
    if os.path.isfile(config_path):
        ...
        SQLALCHEMY_TRACK_MODIFICATIONS = config.get('db','SQLALCHEMY_TRACK_MODIFICATIONS')
